...
<div className="main-content flex flex-col items-start p-5 transition-filter duration-300">
  ...
  <div className="text-section max-w-1/2 ml-2 mr-20"> {/* Increased right margin */}
    <h2 className="text-1xl font mb-4">E-COMMERCE PACKAGES</h2>

    {/* Updated the text color to grey */}
    <h3 className="text-4xl font-bold mb-10 mt-5 text-gray-700">
      We Build Custom e-Commerce solutions covering: Payment Gateway Integrations, 
      Cash on Delivery, Delivery Service Integration, Stock Management, and 
      Customized e-Commerce Features
    </h3>
  </div>
